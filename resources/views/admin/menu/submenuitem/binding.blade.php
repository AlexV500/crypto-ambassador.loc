    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Прив`язка  пункта меню {{ $menuItem->label }} дочірнього пункта меню {{ $parentItem->label }}  ({{$getLocaleName}})</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <h5>Прив`язка дочірнього пункта меню: {{ $menuBindType }}</h5>
                        <hr>
