        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 d-flex align-items-center">
                    <h1 class="m-0 mr-3">Пункт меню "{{$menuItem->label}}" віджета "{{ $menuWidget->name }}" ({{$getLocaleName}})</h1>
                    <a href="{{route('admin.menu.menuitem.edit', $menuWidget->id, $menuItem->id)}}" class="text-success mr-3"><i class="fas fa-pencil-alt"></i></a>
                    <form action="{{route('admin.menu.menuitem.delete', $menuWidget->id, $menuItem->id)}}" method="POST" class="mb-0">
                        @csrf
                        @method('DELETE')
