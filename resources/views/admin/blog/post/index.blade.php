                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                @foreach($posts as $post)
                                    <tr>
                                        ...
                                        <td><x-language-selector :siteEntity="$siteEntity" :contentId="$post->original_content_id" :contentTitle="$post->title" :route="'admin.blog.post.create'"></x-language-selector></td>
