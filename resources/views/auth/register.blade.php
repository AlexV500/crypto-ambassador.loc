            ...
            <div class="row align-items-center">
                <div class="col-xl-7 col-lg-7">
                    <div class="hero-content-wrapper">
                        <h1 class="text-white wow fadeInDown" data-wow-delay=".2s">Register</h1>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">Register With</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 control-label text-md-end">Name</label>
                            <div class="col-md-6">
                                @if(!empty($name))
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 control-label text-md-end">E-Mail Address</label>
                            <div class="col-md-6">
                                @if(!empty($email))
